...
<body>
    ...
    <script>
        ...
        // dan belum punya follow-up yang menutupnya — read-only, untuk kesadaran bahwa
        // ada pekerjaan menggantung. Tampil sebagai bubble mengambang yang bisa digeser
        // bebas (seperti chat-bubble di HP) dan nempel ke tepi terdekat saat dilepas.
        // Posisi terakhir diingat selama tab masih terbuka (sama seperti dashboard_report.php).
        function escTextPending(s) {
        ...
        function makeDraggable(el, dragHandle, onTap) {
            ...
            function onPointerDown(e) {
                if (e.target.closest('#pending-window-close')) return;
                dragging = true;
                moved = false;
