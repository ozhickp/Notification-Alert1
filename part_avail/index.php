...
<body class="min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-5xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <a href="login_user.php" class="menu-card group bg-white p-6 rounded-3xl border border-slate-200 flex flex-col items-start">
            ...
            <a href="dashboard_part.php" class="menu-card group bg-white p-6 rounded-3xl border border-slate-200 flex flex-col items-start">
            ...
            <a href="history_maintenance.php" class="menu-card group bg-white p-6 rounded-3xl border border-slate-200 flex flex-col items-start">
            ...
            <a href="monitor.php" class="menu-card group bg-white p-6 rounded-3xl border border-slate-200 flex flex-col items-start">
        ...
        <div class="mt-10 pt-6 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center gap-2">
                ...
                <span class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Version 1.0</span>
            </div>
